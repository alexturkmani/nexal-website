...
export default function Home() {
  return <main>
    <script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify({'@context':'https://schema.org','@type':'SoftwareApplication',name:'Nexal',applicationCategory:'HealthApplication',operatingSystem:'Android',url:'https://www.nexalfitness.com',downloadUrl:playStoreUrl,description:'AI workout and meal planner with calorie, macro, workout and progress tracking.',offers:{'@type':'Offer',price:'0',priceCurrency:'USD'}})}} />
    <nav className="nav shell"><a href="#top" className="brand" aria-label="Nexal home"><BrandMark /></a><div className="nav-links"><a href="#features">Features</a><a href="/ai-workout-planner">AI Workouts</a><a href="/ai-meal-planner">AI Meals</a></div><PlayButton compact /></nav>
